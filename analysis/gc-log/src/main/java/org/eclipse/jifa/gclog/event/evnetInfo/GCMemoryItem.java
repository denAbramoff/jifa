...
public class GCMemoryItem
{
    ...
    public boolean equals(Object o)
    {
        ...
        return preUsed == item.preUsed && preCapacity == item.preCapacity && postUsed == item.postUsed
                && postCapacity == item.postCapacity && area == item.area;
    }
    ...
    {
        return preUsed == UNKNOWN_INT && preCapacity == UNKNOWN_INT && postUsed == UNKNOWN_INT
                && postCapacity == UNKNOWN_INT;
    }
    ...
    public String toString()
    {
        ...
        String aCase = this.area.toString().toLowerCase();
        sb.append((char)(aCase.charAt(0) - 32)).append(aCase.substring(1)).append(": ");
        if (isEmpty())
        {
            sb.append("unknown");
        }
