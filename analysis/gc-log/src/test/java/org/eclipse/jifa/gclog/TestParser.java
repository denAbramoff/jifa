...
public class TestParser
{
    ...
    public void testJDK11G1Parser() throws Exception
    {
        ...
        Safepoint safepoint = model.getSafepoints().getFirst();
        ...
        GCEvent youngGC = event.getFirst();
        ...
        Assertions.assertEquals(concurrentMark.getPhases().getFirst().getEventType(),
                GCEventType.G1_CONCURRENT_CLEAR_CLAIMED_MARKS);
        Assertions.assertEquals(concurrentMark.getPhases().getFirst().getDuration(), 0.057, DELTA);
        ...
        Assertions.assertTrue(metadata.getImportantEventTypes()
                .contains(GCEventType.G1_CONCURRENT_REBUILD_REMEMBERED_SETS.getName()));
        Assertions.assertFalse(
                metadata.getImportantEventTypes().contains(GCEventType.G1_CONCURRENT_UNDO_CYCLE.getName()));
    }
    ...
    public void testJDK11G1ParserDetectHeapRegionSize() throws Exception
    {
        ...
        Assertions.assertEquals(model.getGcEvents().getFirst().getMemoryItem(OLD)
                , new GCMemoryItem(OLD, 32 * 16 * 1024 * 1024, 37 * 16 * 1024 * 1024, 1952L * 1024 * 1024));
        Assertions.assertEquals(model.getGcEvents().getFirst().getMemoryItem(METASPACE)
    ...
    public void testJDK11ParseDecoration() throws Exception
    {
        String log =
                """
                        [2021-05-06T11:25:16.508+0800][info][gc           ] GC(0) Pause Young (Concurrent Start) (Metadata GC Threshold)
        ...
        log = """
                [1000000000800ms][info][gc           ] GC(0) Pause Young (Concurrent Start) (Metadata GC Threshold)
    ...
    public void testJDK11ZGCParser() throws Exception
    {
        ...
        GCEvent gc = model.getGcEvents().getFirst();
        ...
        Assertions.assertEquals(gc.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 5614L * 1024 * 1024, 40960L * 1024 * 1024, 1454 * 1024 * 1024,
                        40960L * 1024 * 1024));
        ...
        Assertions.assertEquals(72, statistics.getFirst().getStatisticItems().size());
        Assertions.assertEquals(statistics.getFirst().getStartTime(), 7555, DELTA);
        Assertions.assertEquals(statistics.getFirst().get("System: Java Threads threads").getMax10s(), 911, DELTA);
        Assertions.assertEquals(statistics.getFirst().get("System: Java Threads threads").getMax10h(), 913, DELTA);
        ...
        ThreadEvent oom = model.getOoms().getFirst();
    ...
    public void testJDK8CMSParser() throws Exception
    {
        ...
        GCEvent fullgc = model.getGcEvents().getFirst();
        ...
        Assertions.assertEquals(fullgc.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 114217 * 1024, 113775 * 1024, 1153024 * 1024));
        Assertions.assertEquals(fullgc.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 1537414 * 1024, 1388294 * 1024, 4915200L * 1024));
        Assertions.assertEquals(fullgc.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 324459 * 1024, 175339 * 1024, 3072000L * 1024));
        Assertions.assertEquals(fullgc.getPhases().size(), 4);
        Assertions.assertEquals(fullgc.getLastPhaseOfType(GCEventType.WEAK_REFS_PROCESSING).getStartTime(), 611637,
                DELTA);
        Assertions.assertEquals(fullgc.getLastPhaseOfType(GCEventType.WEAK_REFS_PROCESSING).getDuration(), 1.8945,
                DELTA);
        ...
        Assertions.assertEquals(fullgc.getEventType(), GCEventType.FULL_GC);
        Assertions.assertEquals(fullgc.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 3956586L * 1024, 1051300 * 1024, 4019584L * 1024));
        ...
        Assertions.assertEquals(youngGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 69952 * 1024, 11354 * 1024, 253440 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 69952 * 1024, 8704 * 1024, 78656 * 1024));
        ...
        Assertions.assertEquals(cms.getLastPhaseOfType(GCEventType.CMS_CONCURRENT_MARK).getCpuTime().getUser(), 154390,
                DELTA);
        Assertions.assertEquals(cms.getLastPhaseOfType(GCEventType.CMS_FINAL_REMARK).getCpuTime().getUser(), 770,
                DELTA);
    ...
    public void testJDK8CMSCPUTime() throws Exception
    {
        ...
        model.calculateDerivedInfo(new DefaultProgressListener());
        Assertions.assertNotNull(model);
        Assertions.assertEquals(model.getLastEventOfType(GCEventType.CMS_INITIAL_MARK).getCpuTime().getReal(), 130,
                DELTA);
        Assertions.assertEquals(model.getLastEventOfType(GCEventType.CMS_CONCURRENT_MARK).getCpuTime().getUser(), 10,
                DELTA);
        Assertions.assertEquals(model.getLastEventOfType(GCEventType.CMS_CONCURRENT_PRECLEAN).getCpuTime().getReal(),
                30, DELTA);
        Assertions.assertEquals(
                model.getLastEventOfType(GCEventType.CMS_CONCURRENT_ABORTABLE_PRECLEAN).getCpuTime().getReal(), 4650,
                DELTA);
        Assertions.assertEquals(model.getLastEventOfType(GCEventType.CMS_FINAL_REMARK).getCpuTime().getReal(), 30,
                DELTA);
        Assertions.assertEquals(model.getLastEventOfType(GCEventType.CMS_CONCURRENT_SWEEP).getCpuTime().getReal(), 20,
                DELTA);
        Assertions.assertEquals(model.getLastEventOfType(GCEventType.CMS_CONCURRENT_RESET).getCpuTime().getReal(), 40,
                DELTA);
    ...
    public void testJDK8G1GCParser() throws Exception
    {
        ...
        GCEvent youngGC = model.getGcEvents().getFirst();
        ...
        Assertions.assertEquals(youngGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 184 * 1024 * 1024, 3800L * 1024 * 1024, (int)(19.3 * 1024 * 1024),
                        3800L * 1024 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(EDEN),
                new GCMemoryItem(EDEN, 184 * 1024 * 1024, 184 * 1024 * 1024, 0, 160 * 1024 * 1024));
        ...
        Assertions.assertEquals(youngGC.getLastPhaseOfType(GCEventType.G1_CODE_ROOT_SCANNING).getDuration(), 0.5,
                DELTA);
        ...
        Assertions.assertEquals(
                concurrentCycle.getLastPhaseOfType(GCEventType.G1_CONCURRENT_SCAN_ROOT_REGIONS).getStartTime(), 4230,
                DELTA);
        Assertions.assertEquals(
                concurrentCycle.getLastPhaseOfType(GCEventType.G1_CONCURRENT_SCAN_ROOT_REGIONS).getDuration(), 160.8430,
                DELTA);
        Assertions.assertEquals(concurrentCycle.getLastPhaseOfType(GCEventType.G1_REMARK).getStartTime(), 19078, DELTA);
        Assertions.assertEquals(concurrentCycle.getLastPhaseOfType(GCEventType.G1_REMARK).getDuration(), 478.5858,
                DELTA);
        Assertions.assertEquals(
                concurrentCycle.getLastPhaseOfType(GCEventType.G1_PAUSE_CLEANUP).getMemoryItem(HEAP).getPostUsed(),
                9863L * 1024 * 1024, DELTA);
        Assertions.assertEquals(concurrentCycle.getLastPhaseOfType(GCEventType.G1_REMARK).getCpuTime().getUser(), 1470,
                DELTA);
        Assertions.assertEquals(concurrentCycle.getLastPhaseOfType(GCEventType.G1_PAUSE_CLEANUP).getCpuTime().getSys(),
                10, DELTA);
        ...
        Assertions.assertEquals(fullGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 1792694 * 1024, 291615 * 1024, 698368 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, (long)(7521.7 * 1024 * 1024), (long)(46144.0 * 1024 * 1024),
                        (long)(7002.8 * 1024 * 1024), (long)(46144.0 * 1024 * 1024)));
        ...
        GCLogMetadata metadata = model.getGcModelMetadata();
        Assertions.assertFalse(metadata.getImportantEventTypes()
                .contains(GCEventType.G1_CONCURRENT_REBUILD_REMEMBERED_SETS.getName()));
        Assertions.assertFalse(
                metadata.getImportantEventTypes().contains(GCEventType.G1_CONCURRENT_UNDO_CYCLE.getName()));
    }
    ...
    public void testJDK11SerialGCParser() throws Exception
    {
        ...
        Assertions.assertEquals(youngGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 6529 * 1024, 6519 * 1024, 1056768 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 68 * 1024 * 1024, 32 * 1024 * 1024, 247 * 1024 * 1024));
        ...
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 215 * 1024 * 1024, 132 * 1024 * 1024, 247 * 1024 * 1024));
        Assertions.assertEquals(fullGC.getPhases().size(), 4);
        ...
        Assertions.assertEquals(
                fullGC.getLastPhaseOfType(GCEventType.SERIAL_COMPUTE_NEW_OBJECT_ADDRESSES).getDuration(), 26.097,
                DELTA);
        Assertions.assertEquals(fullGC.getLastPhaseOfType(GCEventType.SERIAL_MOVE_OBJECTS).getDuration(), 17.259,
                DELTA);
    }
    ...
    public void testJDK11ParallelGCParser() throws Exception
    {
        ...
        Assertions.assertEquals(youngGC.getCause(), ALLOCATION_FAILURE);
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 65536 * 1024, 10720 * 1024, 76288 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(OLD), new GCMemoryItem(OLD, 0, 20800 * 1024, 175104 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 6531 * 1024, 6531 * 1024, 1056768 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 64 * 1024 * 1024, 30 * 1024 * 1024, 245 * 1024 * 1024));
        Assertions.assertEquals(youngGC.getCpuTime().getReal(), 10, DELTA);
        ...
        Assertions.assertEquals(fullGC.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 141664 * 1024, 94858 * 1024, 175104 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 7459 * 1024, 7459 * 1024, 1056768 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 148 * 1024 * 1024, 92 * 1024 * 1024, 245 * 1024 * 1024));
        ...
        Assertions.assertEquals(fullGC.getLastPhaseOfType(GCEventType.PARALLEL_PHASE_SUMMARY).getDuration(), 0.006,
                DELTA);
        Assertions.assertEquals(fullGC.getLastPhaseOfType(GCEventType.PARALLEL_PHASE_COMPACTION).getDuration(), 22.465,
                DELTA);
    ...
    public void testJDK11CMSGCParser() throws Exception
    {
        ...
        Assertions.assertEquals(youngGC.getCause(), ALLOCATION_FAILURE);
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 69952 * 1024, 8703 * 1024, 78656 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(OLD), new GCMemoryItem(OLD, 0, 24072 * 1024, 174784 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 6531 * 1024, 6530 * 1024, 1056768 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 68 * 1024 * 1024, 32 * 1024 * 1024, 247 * 1024 * 1024));
        ...
        for (GCEvent phase : cms.getPhases())
        {
            ...
            if (phase.getEventType() == GCEventType.CMS_INITIAL_MARK
                    || phase.getEventType() == GCEventType.CMS_FINAL_REMARK)
            {
        ...
        Assertions.assertEquals(cms.getLastPhaseOfType(GCEventType.CMS_CONCURRENT_MARK).getCpuTime().getUser(), 70,
                DELTA);
        ...
        Assertions.assertEquals(cms.getLastPhaseOfType(GCEventType.CMS_CONCURRENT_SWEEP).getMemoryItem(OLD),
                new GCMemoryItem(OLD, 142662 * 1024, 92308 * 1024, 174784 * 1024));
        ...
        Assertions.assertEquals(fullGC.getCause(), ALLOCATION_FAILURE);
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 174 * 1024 * 1024, 166 * 1024 * 1024, 247 * 1024 * 1024));
        ...
        Assertions.assertEquals(
                fullGC.getLastPhaseOfType(GCEventType.SERIAL_COMPUTE_NEW_OBJECT_ADDRESSES).getDuration(), 24.761,
                DELTA);
        Assertions.assertEquals(fullGC.getLastPhaseOfType(GCEventType.SERIAL_MOVE_OBJECTS).getDuration(), 28.069,
                DELTA);
    }
    ...
    public void testJDK8GenerationalGCInterleave() throws Exception
    {
        ...
        Assertions.assertEquals(fullGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 2621440L * 1024, 0, 2883584L * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 1341593L * 1024, 1329988L * 1024, 2097152L * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 3963033L * 1024, 1329988L * 1024, 4980736L * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 310050L * 1024, 309844L * 1024, 1343488L * 1024));
    ...
    public void testJDK11GenerationalGCInterleave() throws Exception
    {
        ...
        Assertions.assertEquals(fullGC.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 142112 * 1024, 135957 * 1024, 174784 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 215 * 1024 * 1024, 132 * 1024 * 1024, 247 * 1024 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 7462 * 1024, 7462 * 1024, 1056768 * 1024));
        Assertions.assertEquals(fullGC.getPhases().size(), 4);
        for (GCEvent phase : fullGC.getPhases())
        {
            Assertions.assertTrue(phase.getStartTime() != UNKNOWN_DOUBLE);
        ...
        Assertions.assertEquals(
                fullGC.getLastPhaseOfType(GCEventType.SERIAL_COMPUTE_NEW_OBJECT_ADDRESSES).getDuration(), 24.314,
                DELTA);
        Assertions.assertEquals(fullGC.getLastPhaseOfType(GCEventType.SERIAL_MOVE_OBJECTS).getDuration(), 17.974,
                DELTA);
    ...
    public void testJDK8ConcurrentPrintDateTimeStamp() throws Exception
    {
        ...
        model.calculateDerivedInfo(new DefaultProgressListener());
        Assertions.assertEquals(model.getGcEvents().size(), 3);
        Assertions.assertEquals(model.getGcEvents().getFirst().getEventType(), GCEventType.YOUNG_GC);
        Assertions.assertEquals(model.getGcEvents().get(1).getEventType(), GCEventType.G1_CONCURRENT_CYCLE);
        Assertions.assertEquals(model.getGcEvents().get(1).getPhases().getFirst().getEventType(),
                GCEventType.G1_CONCURRENT_SCAN_ROOT_REGIONS);
        Assertions.assertEquals(model.getGcEvents().get(1).getPhases().getFirst().getStartTime(), 725081, DELTA);
    ...
    public void TestJDK8CMSPromotionFailed() throws Exception
    {
        ...
        Assertions.assertEquals(fullGC.getEventType(), GCEventType.FULL_GC);
        Assertions.assertEquals(fullGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 7689600L * 1024, 0, 7689600L * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 9258265L * 1024, 5393434L * 1024, 12582912L * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 16878013L * 1024, 5393434L * 1024, 20272512L * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 208055 * 1024, 203568 * 1024, 1253376 * 1024));
    ...
    public void TestJDK8CMSScavengeBeforeRemark() throws Exception
    {
        ...
        Assertions.assertEquals(model.getGcEvents().size(), 3);
        Assertions.assertEquals(model.getLastEventOfType(GCEventType.CMS_FINAL_REMARK).getCpuTime().getUser(), 830,
                DELTA);

        GCEvent youngGC = model.getGcEvents().get(1);
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 1922431L * 1024L, 174720L * 1024L, 1922432L * 1024L));

        youngGC = model.getGcEvents().get(2);
        Assertions.assertEquals(youngGC.getEventType(), GCEventType.YOUNG_GC);
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 1056998L * 1024L, 151245L * 1024L, 1922432L * 1024L));
        ...
        Assertions.assertEquals(pause.pauseAvg(), (226.6431 + 362.9243 + 293.1600) / 3.0, DELTA);
    }
    ...
    public void TestJDK11CMSScavengeBeforeRemark() throws Exception
    {
        ...
        Assertions.assertEquals(model.getGcEvents().size(), 3);
        Assertions.assertEquals(model.getLastEventOfType(GCEventType.CMS_FINAL_REMARK).getCpuTime().getUser(), 90,
                DELTA);

        GCEvent youngGC = model.getGcEvents().getFirst();
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 46079 * 1024L, 5120 * 1024L, 46080 * 1024L));

        youngGC = model.getGcEvents().get(2);
        Assertions.assertEquals(youngGC.getEventType(), GCEventType.YOUNG_GC);
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 5923 * 1024L, 5921 * 1024L, 46080 * 1024L));
        Assertions.assertEquals(youngGC.getCpuTime().getUser(), 70, DELTA);
        Assertions.assertEquals(youngGC.getCause(), CMS_FINAL_REMARK);

        PauseStatistics pause = model.getPauseStatistics(new TimeRange(0, 99999999));
        Assertions.assertEquals(pause.pauseAvg(), (32.662 + 3.259 + 2.784) / 3.0, DELTA);
    }
    ...
    public void TestJDK17SerialGCParser() throws Exception
    {
        ...
        Assertions.assertEquals(youngGC.getCause(), ALLOCATION_FAILURE);
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 40960 * 1024, 46080 * 1024, 5120 * 1024, 46080 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(EDEN),
                new GCMemoryItem(EDEN, 40960 * 1024, 40960 * 1024, 0 * 1024, 40960 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(SURVIVOR),
                new GCMemoryItem(SURVIVOR, 0 * 1024, 5120 * 1024, 5120 * 1024, 5120 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 0, 51200 * 1024, 14524 * 1024, 51200 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 137 * 1024, 384 * 1024, 138 * 1024, 384 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(NONCLASS),
                new GCMemoryItem(NONCLASS, 133 * 1024, 256 * 1024, 134 * 1024, 256 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(CLASS),
                new GCMemoryItem(CLASS, 4 * 1024, 128 * 1024, 4 * 1024, 128 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 40 * 1024 * 1024, 95 * 1024 * 1024, 19 * 1024 * 1024, 95 * 1024 * 1024));
        Assertions.assertEquals(youngGC.getCpuTime().getReal(), 20, DELTA);
        ...
        Assertions.assertEquals(fullGC.getCause(), ALLOCATION_FAILURE);
        Assertions.assertEquals(fullGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 46079 * 1024, 46080 * 1024, 36798 * 1024, 46080 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(EDEN),
                new GCMemoryItem(EDEN, 40960 * 1024, 40960 * 1024, 36798 * 1024, 40960 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(SURVIVOR),
                new GCMemoryItem(SURVIVOR, 5119 * 1024, 5120 * 1024, 0 * 1024, 5120 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 51199 * 1024, 51200 * 1024, 51199 * 1024, 51200 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 137 * 1024, 384 * 1024, 137 * 1024, 384 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(NONCLASS),
                new GCMemoryItem(NONCLASS, 133 * 1024, 256 * 1024, 133 * 1024, 256 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(CLASS),
                new GCMemoryItem(CLASS, 4 * 1024, 128 * 1024, 4 * 1024, 128 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 94 * 1024 * 1024, 95 * 1024 * 1024, 85 * 1024 * 1024, 95 * 1024 * 1024));
        Assertions.assertEquals(fullGC.getPhases().size(), 4);
        for (GCEvent phase : fullGC.getPhases())
        {
            Assertions.assertTrue(phase.getStartTime() != UNKNOWN_DOUBLE);
        ...
        Assertions.assertEquals(
                fullGC.getLastPhaseOfType(GCEventType.SERIAL_COMPUTE_NEW_OBJECT_ADDRESSES).getDuration(), 12.103,
                DELTA);
        Assertions.assertEquals(fullGC.getLastPhaseOfType(GCEventType.SERIAL_MOVE_OBJECTS).getDuration(), 10.313,
                DELTA);
    }
    ...
    public void TestJDK17ParallelGCParser() throws Exception
    {
        ...
        Assertions.assertEquals(youngGC.getCause(), ALLOCATION_FAILURE);
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 38912 * 1024, 45056 * 1024, 6137 * 1024, 45056 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(EDEN),
                new GCMemoryItem(EDEN, 38912 * 1024, 38912 * 1024, 0 * 1024, 38912 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(SURVIVOR),
                new GCMemoryItem(SURVIVOR, 0 * 1024, 6144 * 1024, 6137 * 1024, 6144 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 0, 51200 * 1024, 13208 * 1024, 51200 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 135 * 1024, 384 * 1024, 135 * 1024, 384 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(NONCLASS),
                new GCMemoryItem(NONCLASS, 131 * 1024, 256 * 1024, 131 * 1024, 256 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(CLASS),
                new GCMemoryItem(CLASS, 4 * 1024, 128 * 1024, 4 * 1024, 128 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 38 * 1024 * 1024, (45056 + 51200) * 1024, 18 * 1024 * 1024, 94 * 1024 * 1024));
        Assertions.assertEquals(youngGC.getCpuTime().getReal(), 10, DELTA);
        ...
        Assertions.assertEquals(fullGC.getCause(), ERGONOMICS);
        Assertions.assertEquals(fullGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 6128 * 1024, 45056 * 1024, 0 * 1024, 45056 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(EDEN),
                new GCMemoryItem(EDEN, 0 * 1024, 38912 * 1024, 0 * 1024, 38912 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(SURVIVOR),
                new GCMemoryItem(SURVIVOR, 6128 * 1024, 6144 * 1024, 0 * 1024, 6144 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 46504 * 1024, 51200 * 1024, 38169 * 1024, 51200 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 135 * 1024, 384 * 1024, 135 * 1024, 384 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(NONCLASS),
                new GCMemoryItem(NONCLASS, 131 * 1024, 256 * 1024, 131 * 1024, 256 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(CLASS),
                new GCMemoryItem(CLASS, 4 * 1024, 128 * 1024, 4 * 1024, 128 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 51 * 1024 * 1024, (45056 + 51200) * 1024, 37 * 1024 * 1024, 94 * 1024 * 1024));
        Assertions.assertEquals(fullGC.getPhases().size(), 5);
        for (GCEvent phase : fullGC.getPhases())
        {
            Assertions.assertTrue(phase.getStartTime() != UNKNOWN_DOUBLE);
        ...
        Assertions.assertEquals(fullGC.getLastPhaseOfType(GCEventType.PARALLEL_PHASE_SUMMARY).getDuration(), 0.006,
                DELTA);
        Assertions.assertEquals(fullGC.getLastPhaseOfType(GCEventType.PARALLEL_PHASE_COMPACTION).getDuration(), 6.917,
                DELTA);
    ...
    public void testJDK17ZGCParser() throws Exception
    {
        ...
        Assertions.assertEquals(gc.getLastPhaseOfType(GCEventType.ZGC_PAUSE_MARK_START).getStartTime(), 918 - 0.007,
                DELTA);
        ...
        Assertions.assertEquals(gc.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 104L * 1024 * 1024, 1000L * 1024 * 1024, 88 * 1024 * 1024, 1000L * 1024 * 1024));
        Assertions.assertEquals(gc.getAllocation(), 3 * 1024 * 1024);
        Assertions.assertEquals(gc.getReclamation(), 19L * 1024 * 1024);

        List<ZGCModel.ZStatistics> statistics = model.getStatistics();
        Assertions.assertEquals(statistics.size(), 1);
        Assertions.assertEquals(44, statistics.getFirst().getStatisticItems().size());
        Assertions.assertEquals(statistics.getFirst().getStartTime(), 10417, DELTA);
        Assertions.assertEquals(statistics.getFirst().get("System: Java Threads threads").getMax10s(), 11, DELTA);
        Assertions.assertEquals(statistics.getFirst().get("System: Java Threads threads").getMax10h(), 11, DELTA);
    }
    ...
    public void testJDK17G1Parser() throws Exception
    {
        ...
        Assertions.assertEquals(youngGC.getCause(), G1_EVACUATION_PAUSE);
        Assertions.assertEquals(youngGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 50 * 1024 * 1024, UNKNOWN_INT, 7 * 1024 * 1024, 50 * 1024 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(EDEN),
                new GCMemoryItem(EDEN, 50 * 1024 * 1024, UNKNOWN_INT, 0 * 1024 * 1024, 43 * 1024 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(SURVIVOR),
                new GCMemoryItem(SURVIVOR, 0 * 1024, UNKNOWN_INT, 7 * 1024 * 1024, 7 * 1024 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(OLD),
                new GCMemoryItem(OLD, 0, UNKNOWN_INT, 18 * 1024 * 1024, 50 * 1024 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(ARCHIVE),
                new GCMemoryItem(ARCHIVE, 2 * 1024 * 1024, UNKNOWN_INT, 2 * 1024 * 1024, UNKNOWN_INT));
        Assertions.assertEquals(youngGC.getMemoryItem(HUMONGOUS),
                new GCMemoryItem(HUMONGOUS, 1 * 1024 * 1024, UNKNOWN_INT, 1 * 1024 * 1024, UNKNOWN_INT));
        Assertions.assertEquals(youngGC.getMemoryItem(METASPACE),
                new GCMemoryItem(METASPACE, 87 * 1024, 320 * 1024, 87 * 1024, 320 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(NONCLASS),
                new GCMemoryItem(NONCLASS, 84 * 1024, 192 * 1024, 84 * 1024, 192 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(CLASS),
                new GCMemoryItem(CLASS, 3 * 1024, 128 * 1024, 3 * 1024, 128 * 1024));
        Assertions.assertEquals(youngGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 51 * 1024 * 1024, UNKNOWN_INT, 26 * 1024 * 1024, 100 * 1024 * 1024));
        Assertions.assertEquals(youngGC.getCpuTime().getReal(), 20, DELTA);
        ...
        Assertions.assertEquals(fullGC.getMemoryItem(YOUNG),
                new GCMemoryItem(YOUNG, 0 * 1024 * 1024, UNKNOWN_INT, 0 * 1024 * 1024, 50 * 1024 * 1024));
        Assertions.assertEquals(fullGC.getMemoryItem(HEAP),
                new GCMemoryItem(HEAP, 98 * 1024 * 1024, UNKNOWN_INT, 69 * 1024 * 1024, 100 * 1024 * 1024));
        Assertions.assertEquals(fullGC.getCpuTime().getReal(), 20, DELTA);
        Assertions.assertEquals(fullGC.getPhases().size(), 4);
        for (GCEvent phase : fullGC.getPhases())
        {
    ...
    public void testJDK8G1PrintGC() throws Exception
    {
        ...
        Assertions.assertEquals(model.getGcEvents().stream().filter(event -> event.isTrue(TO_SPACE_EXHAUSTED)).count(),
                2);
