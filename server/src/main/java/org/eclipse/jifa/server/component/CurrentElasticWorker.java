...
{
    private static final Logger LOG = LoggerFactory.getLogger(CurrentElasticWorker.class);
    ...
    public void terminateIfIdle()
    {
        ...
        {
            LOG.info("This elastic worker is currently idle and will be deleted if still not accessed by {}",
                    new Date(lastAccessTime + thresholdInMillis));
        }
    }
}
